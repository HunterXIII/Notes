...
- Всё остальное на проекты
 ...
 5201  dotnet ef dbcontext scaffold "Host=localhost:5432;Username=hunter;Password=I-with76north,;Database=event_organization" Npgsql.EntityFrameworkCore.PostgreSQL -o Models\n
# Практика
